...
class cosmetics:
    ...
    def disp(self):
        ...
        print('customer phone no   :',self.phoneno)
        print('-----------list of products---------')
        print('cost of foundation cream:',self.foundation)
        print('cost of thebbcream      :',self.bbcream)
        print('cost of theeyeliner     :',self.eyeliner)
    ...
    @classmethod
    def modify(cls):
        cosmetics.shopname='NaturalLight'
        cosmetics.address='third cross,whitefield,bangalore'
        cosmetics.contactno=8745877483
cosmetics.modify()
